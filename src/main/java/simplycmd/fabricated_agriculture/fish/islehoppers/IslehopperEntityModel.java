...
public class IslehopperEntityModel<T extends Entity> extends CodEntityModel<T> {
    public IslehopperEntityModel(ModelPart root) {
        super(root);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.NOSE, ModelPartBuilder.create().uv(0, 0).cuboid(-1.0f, -1.0f, -1.0f, 2.0f, 2.0f, 1.0f), ModelTransform.pivot(0.0f, 22.0f, -3.0f));
